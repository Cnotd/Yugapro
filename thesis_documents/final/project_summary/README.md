...
- 论文 LaTeX 源文件：`thesis_yoga.tex`
- 论文编译结果：`thesis_yoga.pdf`
- 论文内容与项目实现对应补充：`THESIS_PROJECT_SUPPLEMENT.md`

如果你需要把毕业设计论文中的系统背景、开发过程、架构演进、关键调试问题和测试结论与代码实现对应起来，建议优先阅读 `THESIS_PROJECT_SUPPLEMENT.md`。
